...
contract GetGroupFromL1AndUpdateL2Script is Script {
    ...
    function run() external {
        ...
        uint256 _groupIdx = vm.envUint("GROUP_INDEX");
        ...
        // get group from L1
        ControllerOracle.Group memory group = ControllerOracle(_controllerAddress).getGroup(_groupIdx);
        ...
        group = ControllerOracle(ControllerOracleAddress).getGroup(_groupIdx);
        console.logUint(group.epoch);
        vm.stopBroadcast();
    }
}
